<?php
/**
 * Prothom Alo Template - Based on real Prothom Alo branding
 * 
 * Brand: Red (#e42313) + White, clean modern design
 * Layout: Full-bleed image with red gradient overlay at bottom
 * Logo top-left, date top-right on semi-transparent dark bar
 * Title in white bold on red gradient at bottom
...
<div class="pcd-photocard" data-language="<?php echo esc_attr($language); ?>" data-quality="<?php echo esc_attr($image_quality); ?>" style="width: 1080px; height: 1080px; background: #000; padding: 0; position: relative; overflow: hidden; box-sizing: border-box;">
    ...
    <div style="position: absolute; bottom: 0; left: 0; right: 0; z-index: 5; display: flex; flex-direction: column;">
        ...
        <div style="background: rgba(0,0,0,0.4); padding: 12px 25px; margin-top: 10px; display: flex; justify-content: center; align-items: center; gap: 25px;">
