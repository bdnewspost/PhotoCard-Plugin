...
<div class="pcd-photocard" data-language="<?php echo esc_attr($language); ?>" data-quality="<?php echo esc_attr($image_quality); ?>" style="width: 1080px; height: 1080px; <?php echo $_bg_style; ?> padding: 0; position: relative; display: flex; flex-direction: column; box-sizing: border-box; overflow: hidden; <?php echo $_border_style; ?>">
    ...
    <!-- Green footer with social -->
    <?php if ($show_facebook || $show_youtube || $show_website || $show_instagram || $show_linkedin): ?>
    <div style="background: <?php echo esc_attr($jg_green); ?>; padding: 12px 25px; flex-shrink: 0; display: flex; justify-content: center; align-items: center; gap: 20px; flex-wrap: wrap;">
        ...
        <div style="display: flex; align-items: center; gap: 5px; color: white; font-size: <?php echo $_social_font_size; ?>px; font-weight: 500;">
            <svg width="<?php echo $_social_icon_size; ?>" height="<?php echo $_social_icon_size; ?>" viewBox="0 0 24 24"><rect width="24" height="24" rx="6" fill="url(#ig-grad-jg)"/><circle cx="12" cy="12" r="5" stroke="white" stroke-width="2" fill="none"/><circle cx="17.5" cy="6.5" r="1.5" fill="white"/><defs><linearGradient id="ig-grad-jg" x1="0" y1="24" x2="24" y2="0"><stop offset="0%" stop-color="#feda75"/><stop offset="25%" stop-color="#fa7e1e"/><stop offset="50%" stop-color="#d62976"/><stop offset="75%" stop-color="#962fbf"/><stop offset="100%" stop-color="#4f5bd5"/></linearGradient></defs></svg>
        ...
        <div style="display: flex; align-items: center; gap: 5px; color: <?php echo esc_attr($jg_gold); ?>; font-size: <?php echo $_social_font_size; ?>px; font-weight: 600;">
            <svg width="<?php echo $_social_icon_size; ?>" height="<?php echo $_social_icon_size; ?>" viewBox="0 0 24 24" fill="<?php echo esc_attr($jg_gold); ?>"><circle cx="12" cy="12" r="10"/></svg>
