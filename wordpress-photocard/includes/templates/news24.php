...
?>
<div class="pcd-photocard" data-language="<?php echo esc_attr($language); ?>" data-quality="<?php echo esc_attr($image_quality); ?>" style="width: 1080px; height: 1080px; padding: 0; position: relative; overflow: hidden; box-sizing: border-box; background: #1a0505; <?php echo $_border_style; ?>">
    
    <!-- Post Featured Image -->
    <?php if ($_fi_has_spacing): ?>
    <div style="position: absolute; top: <?php echo $_fi_padding_top; ?>px; left: <?php echo $_fi_padding_left; ?>px; right: <?php echo $_fi_padding_right; ?>px; height: 68%; z-index: 1; overflow: hidden; <?php echo $_fi_border_style; ?>">
    ...
    <?php else: ?>
    <img src="<?php echo esc_url($thumbnail_url); ?>" alt="<?php echo esc_attr($post_title); ?>" style="position: absolute; top: 0; left: 0; width: 100%; height: 68%; object-fit: <?php echo esc_attr($_fi_object_fit); ?>; object-position: <?php echo esc_attr($_fi_object_position); ?>; z-index: 1; <?php echo $_fi_zoom_style; ?>" crossorigin="anonymous">
    <?php endif; ?>
    ...
    <div style="position: absolute; top: <?php echo $_content_top; ?>px; bottom: 0; left: 0; right: 0; z-index: 5; display: flex; flex-direction: column; justify-content: flex-start; padding-top: 30px;">
        ...
        <div style="padding: 10px 30px 14px; display: flex; justify-content: center; align-items: center; gap: 35px; flex-wrap: wrap;">
            ...
            <div style="display: flex; align-items: center; gap: 8px; color: white; font-size: <?php echo $_social_font_size; ?>px; font-weight: 500;">
